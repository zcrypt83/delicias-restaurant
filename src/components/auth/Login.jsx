...
function Login() {
  ...
  const demoAccounts = [
    ...
    { role: 'Cocinero', email: 'cocinero@delicias.com', password: 'cocina123', color: 'warning' },
    { role: 'Mesero', email: 'mesero@delicias.com', password: 'mesero123', color: 'info' },
    { role: 'Cajero', email: 'cajero@delicias.com', password: 'caja123', color: 'success' },
    { role: 'Cliente', email: 'cliente@ejemplo.com', password: 'cliente123', color: 'secondary' }
  ];
