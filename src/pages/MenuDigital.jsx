...
function MenuDigital() {
  ...
  const handleAddToCart = (item) => {
    if (item.modifiers.obligatorios.length > 0) {
  ...
  const handleCustomizeAndAdd = () => {
    const missingObligatorios = selectedItem.modifiers.obligatorios.filter(
                    ...
                    <Card className="h-100 border-0 shadow-sm hover-lift">
                      <Card.Body className="p-4 d-flex flex-column">
                        <div className="d-flex justify-content-between align-items-start mb-3">
                          <div className="display-3 text-warning">{item.image}</div>
                          <Badge bg="success">
                        ...
                        <div className="flex-grow-1">
                          ...
                          <div className="d-flex flex-wrap gap-2 mb-3">
                            ...
                            {item.modifiers.opcionales.length > 0 && (
                              <Badge bg="info">
        ...
        {selectedItem && (
          <>
            ...
            <Modal.Body className="p-4">
              ...
              {selectedItem.modifiers.obligatorios.map(modifier => (
              ...
              {selectedItem.modifiers.opcionales.length > 0 && (
                <div className="mb-4">
                  <h6 className="fw-semibold mb-3">Adiciones Opcionales</h6>
                  <div className="row g-2">
                    {selectedItem.modifiers.opcionales.map(modifier => (
